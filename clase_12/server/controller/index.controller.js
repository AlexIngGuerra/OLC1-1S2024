...
const { arreglo, vaciar } = require("../util/data.js");
...
const analizar = (req, res) => {
    ...
    res.status(200).json({message: "Analisis finalizado"})
}


const getSalida = (req, res) => {
    res.status(200).json({salidas: arreglo});
}

// Exportar para usarlo en otros archivos
module.exports = {
    index, analizar, getSalida
}