...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\014\000\006\004\010\005\004\001\002\000\006\004" +
    "\010\005\004\001\002\000\010\002\000\004\010\005\004" +
    "\001\002\000\004\002\011\001\002\000\010\002\ufffe\004" +
    "\ufffe\005\ufffe\001\002\000\014\002\ufffd\004\ufffd\005\ufffd" +
    "\006\ufffd\007\ufffd\001\002\000\004\002\001\001\002\000" +
    "\010\002\uffff\004\uffff\005\uffff\001\002\000\004\006\014" +
    "\001\002\000\006\004\010\005\004\001\002\000\004\007" +
    "\016\001\002\000\014\002\ufffc\004\ufffc\005\ufffc\006\ufffc" +
    "\007\ufffc\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\004\004\012\001\001\000\004\004\011\001\001\000\002" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // lista ::= lista expresion 
            {
              Object RESULT =null;
		int expleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int expright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Object exp = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		func.Funcion.lista.add(exp.toString());
		...
		String val = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = val; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // expresion ::= SUM expresion COMA expresion PYC 
            {
              Object RESULT =null;
		...
		Object b = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = func.Funcion.Suma(a.toString(), b.toString()); 
